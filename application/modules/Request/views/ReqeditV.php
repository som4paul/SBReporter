            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="page-title-box">
                        <h4 class="page-title">Please Edit Request Report Attributes :-</h4>
                        <div class="clearfix"></div>
                    </div>
                </div>
            </div>
             <?php $dos_selected =  $requests[0]['REQ_TO'] ; $dos_selected = explode(',',$dos_selected);  $dos_selected =array_filter($dos_selected);
                            echo form_open(base_url('Request/Reqedit'));
                        ?>

                   <input type="hidden" name="REQID" value="<?php echo $requests[0]['REQID'] ; ?>">
                   <input type="hidden" name="REQ_PATH" value="<?php echo $requests[0]['REQ_PATH'] ; ?>">
                   	...
                   	<div class="panel-heading">
                        ...
                        <div class="panel-body">				
	                                            ...
	                                            <div class="form-group">
	                                                ...
	                                                <div class="col-md-10">
	                                                    <textarea class="form-control max" maxlength="500" name="REQ_NOTE" rows="5"><?php echo $requests[0]['REQ_NOTE'] ; ?></textarea>
	                                                </div>
	                                            </div>
	                                     ...
	                                     <select class="col-md-10 selectpicker" data-live-search="true" data-style="btn-teal" tabindex="-98" multiple="multiple" required name="REQ_TO[]">
                                           ...
                                           <?php  foreach ($do_name as $key => $value) {
                                           	...
                                           	for($k=0,$selected = '';$k<count($dos_selected);$k++)
                                           	{if($value['OFID']==$dos_selected[$k])
                                           			{
                                           				$selected = 'selected' ;
                                           				 //terminate for() loop 
                                           			}         			
