            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="page-title-box">
                        <h4 class="page-title">AC wise PS wise 1B-2B Report</h4>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <select class="form-control acidforps">
                                        <option>Select AC</option>
                                        <?php foreach($ac_data as $val){ ?>
                                            <option value="<?php echo $val['ACNO'];?>"><?php echo $val['ACNAME']?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                        </div><br><br><br><br>
                        <div class="row" id="acpslist">
                            <div class="col-xs-12">
