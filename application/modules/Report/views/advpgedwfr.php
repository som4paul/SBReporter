            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="page-title-box">
                        <h4 class="page-title">Please Select Advance Report Attributes to edit</h4>
                        <div class="clearfix"></div>
                    </div>
                </div>
            </div>
             <?php
                            echo form_open(base_url('Report/Advrepeditwfr'));
                            //pre($repdet,1) ; 
                        ?>
				...
				<div class="panel panel-border panel-teal hi1000 wid1000" align="center">
                   	<div class="panel-heading">
                        ...
                        <div class="panel-body">
	                                      ...
	                                      <?php if($repdet['EVID']==$value['EVID']){?> 
	                                      	<option selected value="<?php echo $value['EVID'];?>"><?php echo $value['EVENT_NAME'];?></option>
                                           ...
                                           <?php }  } ?>                                       
                             				...
                             				<input type="text" class="form-control max" maxlength="50" name="OTHEREVENT" placeholder="please enter other event type" >
	                                            ...
	                                            <div class="form-group">
	                                                ...
	                                                <div class="col-md-10">
	                                                    <input type="date" class="form-control" name="RP_DATE" required value="<?php echo $repdet['RP_DATE'] ;?>" 
	                                                    >
	                                                </div>
	                                            </div>
	                                            <div class="form-group">
	                                                ...
	                                                <div class="col-md-10">
	                                                    <input type="time" name="RP_TIME" class="form-control" value="<?php echo $repdet['RP_TIME'] ;?>" required>
	                                                </div>
	                                            </div>
	                                             <div class="form-group">
	                                                <label class="col-md-2 control-label">Program End Time</label>
	                                                <div class="col-md-10">
	                                                    <input type="time" name="RP_TIME_END" class="form-control" value="<?php echo $repdet['RP_TIME_END'] ;?>" required>
	                                                </div>
	                                            </div>
	                                            <div class="form-group">
	                                                <label class="col-md-2 control-label">Venue</label>
	                                                <div class="col-md-10">
	                                                    <input type="text" class="form-control max" maxlength="150" name="VENUE" value="<?php echo $repdet['VENUE'] ;?>">
	                                                </div>
	                                            </div>
	                                            ...
	                                            <div class="form-group">
	                                                ...
	                                                <div class="col-md-10">
	                                                    <input type="text" class="form-control max" maxlength="100" name="ORGANIZATION" value="<?php echo $repdet['ORGANIZATION'];?>" required>
	                                                </div>
	                                            ...
	                                            <div class="form-group">
	                                                ...
	                                                <div class="col-md-10">
	                                                    <input type="text" class="form-control max" maxlength="50" name="ISSUE" value="<?php echo $repdet['ISSUE'];?>" >
	                                                </div>
	                                            </div>   
	                                            <div class="form-group">
	                                                <label class="col-md-2 control-label">Expected Strength</label>
	                                                <div class="col-md-10">
	                                                    <input type="number" class="form-control" name="STRENGTH" value="<?php echo $repdet['STRENGTH'];?>">
	                                                </div>
	                                            ...
	                                            <div class="form-group">
	                                                ...
	                                                <div class="col-md-10">
	                                                    <input type="text" class="form-control max" maxlength="50" name="LEADERSHIP" value="<?php echo $repdet['LEADERSHIP'];?>">
	                                                </div>
	                                            ...
	                                            <div class="form-group">
	                                                ...
	                                                <div class="col-md-10">
	                                                    <textarea class="form-control max" maxlength="500" name="NOTE" rows="5" ><?php echo $repdet['NOTE'];?></textarea>
	                                                </div>
	                                            </div>
	                                           <div class="form-group">
	                                     ...
	                                     <select class="col-md-10 selectpicker" data-live-search="true" data-style="btn-teal" tabindex="-98" required name="OFID" >
                                           ...
                                           <?php  foreach ($offcr_name as $key => $value) {  if($repdet['OFID']==$value['OFID']){?> 
	                                                	   
                                            <option selected value="<?php echo $value['OFID'];?>"><?php echo $value['OF_NAME']."(".$value['DESIG_NAME'].") - ".$value['PS_NAME']?></option>
                                            <?php } else {?>
	                                     ...
	                                     <select id="dolist"class="col-md-10 selectpicker" data-live-search="true" data-style="btn-teal" tabindex="-98" required multiple="multiple" name="OTHR_OFIDS[]">
                                           ...
                                           <option value="99">Deputy Commissioner</option>
                                           ...
                                           <?php  } ?>  -->                                       
	       										...
	       										<div class="form-group">
	                                                <label class="col-md-2 control-label">Upload Reports </label>                                 
	                                                   <input type="hidden" value="<?php echo $repdet['FILE_PATH'];?>" name="FILE_PATH">                                	       <input type="hidden" value="<?php echo $repdet['RP_ID'];?>" name="RP_ID">   
