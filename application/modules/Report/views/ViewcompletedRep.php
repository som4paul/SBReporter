...
<div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    <h4 class="m-t-0 header-title"><b>Completed Reports:-</b></h4>
                                    <p class="text-muted font-13 m-b-30">
                                        Please find below the Completed Reports  accordingly
                                    </p>
        ...
        <?php  if(!empty($reports_details)) { ?>
            <?php for($i=0;$i<count($reports_details);$i++) {?>
                                            ...
                                            <td><?php echo $reports_details[$i]['RP_LOG_ID'] ; ?></td>                <td><?php echo $reports_details[$i]['RP_PRESENT_STATUS'] ; ?></td>                             
 ...
 -->                        <?php if($this->session->userdata('IS_DO')!=1){?>
                                             <td><a id="<?php echo $reports_details[$i]['RP_ID']?>" href="#">
                                          <i class="glyphicon glyphicon-open-file"></i></a></td>

                                            <?php }//end of if superior check?>
                                              </tr>
